 ...
 */
public fun exportSvg(svgElement: SVGElement, filename: String = "diagram.svg") {
 ...
 */
public suspend fun exportPng(svgElement: SVGElement, filename: String = "diagram.png") {
  try {
 ...
 */
public fun exportMmd(code: String, filename: String = "diagram.mmd") {
  val blob = Blob(
    arrayOf(code),
